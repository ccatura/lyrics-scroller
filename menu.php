<div class='menu' id='menu'>
    ...
    <a href='./?page=song_list' class='menu-item'>Songs</a>
    <a href='./?page=setlists' class='menu-item'>Setlists</a>
    <a href='./?page=song_search' class='menu-item'>Search</a>
    <hr style='width:100%'>
    <a href='./?page=setlists' class='menu-item'>Create Setlist</a>
    <a href='./?page=create_edit' class='menu-item'>Create Song</a>
    ...
    <?php if ($_GET['page'] == 'scroller' && !$_SESSION['draft']) {
        ...
        echo "<a class='menu-item'>Save Settings for:</a>";
